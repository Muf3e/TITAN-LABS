...
export const SAMPLE_PRODUCTS: SampleProduct[] = [
  ...
  },
  {
    ...
    variant: '18" 2.5K Mini-LED 240Hz • Core Ultra 9 290HX+ • RTX 5090 (16GB)',
    category: 'Laptop',
    brand: 'ASUS',
    priceInInr: 349990,
    originalPriceInInr: 379990,
    discountPercent: 8,
    retailerCount: 4,
    titanScore: 98,
    evidenceConfidence: 96,
    onlineRating: 4.9,
    onlineRatingCount: 520,
    lastVerifiedDaysAgo: 1,
    availability: Availability.IN_STOCK,
    topPro: 'Unrivaled RTX 5090 GPU & 1100-nit Mini-LED 240Hz panel',
    topCon: 'Heavy 3.1kg chassis with high power brick weight',
    imageKey: 'prod_asus_scar18',
    imageUrl: '/products/asus-rog-strix-g16.png',
    ramGb: 64,
    storageGb: 2048,
    processor: 'Intel Core Ultra 9 290HX Plus (24C/32T)',
    gpu: 'NVIDIA GeForce RTX 5090 (16GB GDDR7, 175W TGP)',
    hasDedicatedGpu: true,
    displaySizeInches: 18.0,
    refreshRateHz: 240,
    batteryCapacity: '90Wh',
    os: 'Windows 11 Pro',
    weightKg: 3.1,
    dimensionMetrics: {
      [TitanDimension.PERFORMANCE]: [
        { name: 'Geekbench 6 Multi-Core', score: 99, weight: 1.0, confidence: 0.98 },
        { name: '3DMark TimeSpy Extreme', score: 99, weight: 1.0, confidence: 0.98 },
      ],
      [TitanDimension.UX_DISPLAY]: [
        { name: '18" 240Hz 2.5K Mini-LED 1100-nit', score: 98, weight: 1.0, confidence: 0.96 },
      ],
      [TitanDimension.BATTERY_EFFICIENCY]: [
        { name: 'Extreme Power Envelope Endurance', score: 72, weight: 1.0, confidence: 0.85 },
      ],
      [TitanDimension.BUILD_THERMALS_RELIABILITY]: [
        { name: 'Conductonaut Extreme Liquid Metal & Tri-Fan', score: 96, weight: 1.0, confidence: 0.95 },
      ],
      [TitanDimension.FEATURES_CAPABILITY]: [
        { name: 'Thunderbolt 5, Wi-Fi 7 & 2.5G LAN', score: 99, weight: 1.0, confidence: 0.95 },
      ],
      [TitanDimension.CAMERA_OR_CREATOR]: [
        { name: '16GB VRAM CUDA/OptiX AI Acceleration', score: 99, weight: 1.0, confidence: 0.98 },
      ],
      [TitanDimension.SOFTWARE_SUPPORT]: [
        { name: 'Armoury Crate & Enterprise BIOS Support', score: 92, weight: 1.0, confidence: 0.92 },
      ],
      [TitanDimension.VALUE_FOR_MONEY]: [
        { name: 'Halo Flagship Benchmark to Cost Ratio', score: 82, weight: 1.0, confidence: 0.90 },
      ],
    },
  },
  {
    id: 'asus-rog-zephyrus-g16-ai',
    name: 'ASUS ROG Zephyrus G16 AI (2026)',
    variant: '16" 2.5K OLED 240Hz • Ryzen AI 9 HX 370 • RTX 5080 (16GB)',
    category: 'Laptop',
    brand: 'ASUS',
    priceInInr: 279990,
    originalPriceInInr: 299990,
    discountPercent: 7,
    retailerCount: 4,
    titanScore: 96,
    evidenceConfidence: 94,
    ...
    lastVerifiedDaysAgo: 1,
    availability: Availability.IN_STOCK,
    topPro: 'Sub-2kg ultra-portable form factor with gorgeous 240Hz OLED & RTX 5080',
    topCon: 'Soldered memory restricts post-purchase RAM upgrades',
    imageKey: 'prod_asus_zephyrus',
    imageUrl: '/products/asus-rog-strix-g16.png',
    ramGb: 32,
    storageGb: 1024,
    processor: 'AMD Ryzen AI 9 HX 370 (50 NPU TOPS)',
    gpu: 'NVIDIA GeForce RTX 5080 (16GB GDDR7, 115W TGP)',
    hasDedicatedGpu: true,
    displaySizeInches: 16.0,
    refreshRateHz: 240,
    batteryCapacity: '90Wh',
    ...
    dimensionMetrics: {
      [TitanDimension.PERFORMANCE]: [
        { name: 'Ryzen AI + RTX 5080 Graphics Matrix', score: 95, weight: 1.0, confidence: 0.95 },
      ],
      [TitanDimension.UX_DISPLAY]: [
        { name: 'ROG Nebula OLED 240Hz 0.2ms 100% DCI-P3', score: 99, weight: 1.0, confidence: 0.98 },
      ],
      [TitanDimension.BATTERY_EFFICIENCY]: [
        { name: '90Wh Battery with 50 NPU TOPS Efficiency', score: 88, weight: 1.0, confidence: 0.90 },
      ],
      [TitanDimension.BUILD_THERMALS_RELIABILITY]: [
        { name: 'CNC Aluminum Unibody & Vapor Chamber', score: 94, weight: 1.0, confidence: 0.92 },
      ],
      [TitanDimension.FEATURES_CAPABILITY]: [
        { name: 'USB4, SD Express 7.0 & Wi-Fi 7', score: 95, weight: 1.0, confidence: 0.92 },
      ],
      [TitanDimension.CAMERA_OR_CREATOR]: [
        { name: 'Studio Grade OLED Color & 16GB VRAM', score: 98, weight: 1.0, confidence: 0.95 },
      ],
      [TitanDimension.SOFTWARE_SUPPORT]: [
        { name: 'ASUS Copilot+ & Armoury Crate Suite', score: 92, weight: 1.0, confidence: 0.90 },
      ],
      [TitanDimension.VALUE_FOR_MONEY]: [
        { name: 'Thin-and-Light Halo Engineering Value', score: 85, weight: 1.0, confidence: 0.88 },
      ],
    },
  },
  {
    id: 'lenovo-legion-pro-7i-ai',
    name: 'Lenovo Legion Pro 7i Gen 9 AI',
    variant: '16" WQXGA 240Hz • Core i9-14900HX • RTX 5080 (16GB)',
    category: 'Laptop',
    brand: 'Lenovo',
    priceInInr: 239990,
    originalPriceInInr: 259990,
    discountPercent: 8,
    retailerCount: 5,
    titanScore: 95,
    evidenceConfidence: 94,
    onlineRating: 4.8,
    onlineRatingCount: 940,
    lastVerifiedDaysAgo: 1,
    availability: Availability.IN_STOCK,
    topPro: 'Vapor chamber cooling with sustained 175W GPU boost and 99.9Wh battery',
    topCon: 'Aggressive industrial chassis aesthetics',
    imageKey: 'prod_lenovo_legion_pro7',
    imageUrl: '/products/lenovo-legion-5-pro.png',
    ramGb: 32,
    storageGb: 1024,
    processor: 'Intel Core i9-14900HX (24 Cores)',
    gpu: 'NVIDIA GeForce RTX 5080 (16GB GDDR7, 175W TGP)',
    hasDedicatedGpu: true,
    displaySizeInches: 16.0,
    refreshRateHz: 240,
    ...
    dimensionMetrics: {
      [TitanDimension.PERFORMANCE]: [
        { name: 'Full Power 175W GPU & Core i9 Benchmarks', score: 96, weight: 1.0, confidence: 0.95 },
      ],
      [TitanDimension.UX_DISPLAY]: [
        { name: 'PureSight Gaming 240Hz 500 nits WQXGA', score: 94, weight: 1.0, confidence: 0.92 },
      ],
      [TitanDimension.BATTERY_EFFICIENCY]: [
        { name: 'Max Airline Limit 99.9Wh Battery Pack', score: 82, weight: 1.0, confidence: 0.88 },
      ],
      [TitanDimension.BUILD_THERMALS_RELIABILITY]: [
        { name: 'Legion Coldfront Vapor Chamber & AI Tuning', score: 96, weight: 1.0, confidence: 0.94 },
      ],
      [TitanDimension.FEATURES_CAPABILITY]: [
        { name: 'Full I/O Array, Thunderbolt 4 & Upgradable RAM', score: 96, weight: 1.0, confidence: 0.92 },
      ],
      [TitanDimension.CAMERA_OR_CREATOR]: [
        { name: '16GB VRAM & Dual NVMe Expansion', score: 95, weight: 1.0, confidence: 0.92 },
      ],
      [TitanDimension.SOFTWARE_SUPPORT]: [
        { name: 'Lenovo Vantage & 3-Yr Onsite Warranty Option', score: 94, weight: 1.0, confidence: 0.90 },
      ],
      [TitanDimension.VALUE_FOR_MONEY]: [
        { name: 'Category Leading Performance-per-Rupee', score: 91, weight: 1.0, confidence: 0.92 },
      ],
    },
  },
  {
    id: 'msi-raider-18-hx-ai',
    name: 'MSI Raider 18 HX AI (2026)',
    variant: '18" 4K 120Hz Mini-LED • Core Ultra 9 • RTX 5090 (16GB)',
    category: 'Laptop',
    brand: 'MSI',
    priceInInr: 389990,
    originalPriceInInr: 419990,
    discountPercent: 7,
    retailerCount: 3,
    titanScore: 97,
    evidenceConfidence: 95,
    onlineRating: 4.8,
    onlineRatingCount: 310,
    lastVerifiedDaysAgo: 2,
    availability: Availability.IN_STOCK,
    topPro: 'Desktop replacement powerhouse with 4K Mini-LED and 64GB DDR5',
    topCon: 'Extreme 3.6kg bulk and loud high-load fans',
    imageKey: 'prod_msi_raider',
    imageUrl: '/products/asus-rog-strix-g16.png',
    ramGb: 64,
    storageGb: 2048,
    ...
    dimensionMetrics: {
      [TitanDimension.PERFORMANCE]: [
        { name: '250W Combined CPU+GPU Power Sustained', score: 99, weight: 1.0, confidence: 0.98 },
      ],
      [TitanDimension.UX_DISPLAY]: [
        { name: '18" 4K 120Hz 1000 nits Mini-LED Panel', score: 97, weight: 1.0, confidence: 0.95 },
      ],
      [TitanDimension.BATTERY_EFFICIENCY]: [
        { name: 'High-Wattage Power Draw Endurance', score: 68, weight: 1.0, confidence: 0.82 },
      ],
      [TitanDimension.BUILD_THERMALS_RELIABILITY]: [
        { name: 'Massive Dual Vapor Chambers & 6 Exhausts', score: 95, weight: 1.0, confidence: 0.94 },
      ],
      [TitanDimension.FEATURES_CAPABILITY]: [
        { name: '4x DDR5 Slots, 2x Thunderbolt 5 & Wi-Fi 7', score: 99, weight: 1.0, confidence: 0.96 },
      ],
      [TitanDimension.CAMERA_OR_CREATOR]: [
        { name: '4K Display + 16GB VRAM Content Monster', score: 98, weight: 1.0, confidence: 0.96 },
      ],
      [TitanDimension.SOFTWARE_SUPPORT]: [
        { name: 'MSI Center AI Engine', score: 86, weight: 1.0, confidence: 0.88 },
      ],
      [TitanDimension.VALUE_FOR_MONEY]: [
        { name: 'Extreme Flagship Cost Efficiency', score: 79, weight: 1.0, confidence: 0.88 },
      ],
    },
  },
  {
    id: 'acer-predator-helios-16-ai',
    name: 'Acer Predator Helios 16 AI',
    variant: '16" WQXGA 240Hz • Core i9-14900HX • RTX 5070 Ti (12GB)',
    category: 'Laptop',
    brand: 'Acer',
    priceInInr: 199990,
    originalPriceInInr: 219990,
    discountPercent: 9,
    retailerCount: 4,
    titanScore: 92,
    evidenceConfidence: 91,
    onlineRating: 4.6,
    onlineRatingCount: 780,
    lastVerifiedDaysAgo: 1,
    availability: Availability.IN_STOCK,
    topPro: 'Superb price-to-performance RTX 5070 Ti with 12GB VRAM',
    topCon: 'Plastic accents on keyboard deck',
    imageKey: 'prod_acer_helios',
    imageUrl: '/products/asus-rog-strix-g16.png',
    ramGb: 32,
    storageGb: 1024,
    ...
    dimensionMetrics: {
      [TitanDimension.PERFORMANCE]: [
        { name: 'RTX 5070 Ti 140W Gaming & Compute', score: 93, weight: 1.0, confidence: 0.94 },
      ],
      [TitanDimension.UX_DISPLAY]: [
        { name: '240Hz WQXGA 500-nit IPS Matrix', score: 92, weight: 1.0, confidence: 0.92 },
      ],
      [TitanDimension.BATTERY_EFFICIENCY]: [
        { name: 'Standard Gaming Longevity (4.5h video)', score: 76, weight: 1.0, confidence: 0.86 },
      ],
      [TitanDimension.BUILD_THERMALS_RELIABILITY]: [
        { name: '5th Gen AeroBlade 3D Liquid Metal Fans', score: 92, weight: 1.0, confidence: 0.90 },
      ],
      [TitanDimension.FEATURES_CAPABILITY]: [
        { name: 'Thunderbolt 4, Killer Wi-Fi 7 & MicroSD', score: 92, weight: 1.0, confidence: 0.90 },
      ],
      [TitanDimension.CAMERA_OR_CREATOR]: [
        { name: '12GB VRAM Local AI & 3D Render Ready', score: 93, weight: 1.0, confidence: 0.92 },
      ],
      [TitanDimension.SOFTWARE_SUPPORT]: [
        { name: 'PredatorSense 5.0 Utility', score: 88, weight: 1.0, confidence: 0.88 },
      ],
      [TitanDimension.VALUE_FOR_MONEY]: [
        { name: 'Under-200K RTX 50-Series Value King', score: 92, weight: 1.0, confidence: 0.92 },
      ],
    },
  },
  {
    id: 'asus-rog-strix-g16-2026',
    name: 'ASUS ROG Strix G16 (2026) G615LR',
    variant: '16" ROG Nebula 165Hz • Core Ultra 9 • RTX 5070 (12GB)',
    category: 'Laptop',
    brand: 'ASUS',
    priceInInr: 179990,
    originalPriceInInr: 199990,
    discountPercent: 10,
    retailerCount: 4,
    titanScore: 92,
    evidenceConfidence: 92,
    onlineRating: 4.7,
    onlineRatingCount: 890,
    lastVerifiedDaysAgo: 1,
    availability: Availability.IN_STOCK,
    topPro: 'Balanced thermal dissipation with ROG Nebula 16:10 display',
    topCon: 'Substantial 2.5kg carry weight',
    imageKey: 'prod_asus_strix_2026',
    imageUrl: '/products/asus-rog-strix-g16.png',
    ramGb: 32,
    storageGb: 1024,
    processor: 'Intel Core Ultra 9 285H',
    gpu: 'NVIDIA GeForce RTX 5070 (12GB GDDR7, 140W TGP)',
    hasDedicatedGpu: true,
    displaySizeInches: 16.0,
    refreshRateHz: 165,
    batteryCapacity: '90Wh',
    ...
    dimensionMetrics: {
      [TitanDimension.PERFORMANCE]: [
        { name: 'RTX 5070 12GB & Ultra 9 Compute', score: 92, weight: 1.0, confidence: 0.93 },
      ],
      [TitanDimension.UX_DISPLAY]: [
        { name: 'ROG Nebula 165Hz 100% DCI-P3 Display', score: 91, weight: 1.0, confidence: 0.92 },
      ],
      [TitanDimension.BATTERY_EFFICIENCY]: [
        { name: 'Core Ultra 9 Energy Efficiency', score: 82, weight: 1.0, confidence: 0.88 },
      ],
      [TitanDimension.BUILD_THERMALS_RELIABILITY]: [
        { name: 'Liquid Metal & Full-Surround Vents', score: 93, weight: 1.0, confidence: 0.92 },
      ],
      [TitanDimension.FEATURES_CAPABILITY]: [
        { name: 'Thunderbolt 4, Wi-Fi 6E & HDMI 2.1', score: 91, weight: 1.0, confidence: 0.90 },
      ],
      [TitanDimension.CAMERA_OR_CREATOR]: [
        { name: '12GB VRAM Studio Driver Support', score: 92, weight: 1.0, confidence: 0.90 },
      ],
      [TitanDimension.SOFTWARE_SUPPORT]: [
        { name: 'Armoury Crate & ROG Ecosystem', score: 90, weight: 1.0, confidence: 0.90 },
      ],
      [TitanDimension.VALUE_FOR_MONEY]: [
        { name: 'Price-to-Benchmark Ratio under 180K', score: 91, weight: 1.0, confidence: 0.92 },
      ],
    },
  },
  {
    id: 'asus-rog-strix-g16-refurb',
    name: 'ASUS ROG Strix G16 Certified Refurbished',
    variant: '16" FHD+ 165Hz • Core i9 14th Gen • RTX 4070 (8GB)',
    category: 'Laptop',
    brand: 'ASUS',
    priceInInr: 139990,
    originalPriceInInr: 219990,
    ...
    evidenceConfidence: 88,
    onlineRating: 4.4,
    onlineRatingCount: 410,
    lastVerifiedDaysAgo: 1,
    availability: Availability.LIMITED,
    topPro: 'Tremendous 36% discount on verified certified hardware with official warranty',
    topCon: 'Refurbished cosmetics with minor micro-scratches',
    imageKey: 'prod_asus_refurb',
    imageUrl: '/products/asus-rog-strix-g16.png',
    ramGb: 16,
    storageGb: 1024,
    processor: 'Intel Core i9-14900HX',
    ...
    dimensionMetrics: {
      [TitanDimension.PERFORMANCE]: [
        { name: 'Core i9-14900HX & RTX 4070 Matrix', score: 90, weight: 1.0, confidence: 0.90 },
      ],
      [TitanDimension.UX_DISPLAY]: [
        { name: '165Hz FHD+ 16:10 Panel', score: 88, weight: 1.0, confidence: 0.90 },
      ],
      [TitanDimension.BATTERY_EFFICIENCY]: [
        { name: 'Standard 90Wh Battery Pack', score: 76, weight: 1.0, confidence: 0.85 },
      ],
      [TitanDimension.BUILD_THERMALS_RELIABILITY]: [
        { name: 'Official Factory Re-certified Thermal Paste', score: 88, weight: 1.0, confidence: 0.88 },
      ],
      [TitanDimension.FEATURES_CAPABILITY]: [
        { name: 'Dual RAM Slots Upgradable to 64GB', score: 92, weight: 1.0, confidence: 0.90 },
      ],
      [TitanDimension.CAMERA_OR_CREATOR]: [
        { name: 'RTX 4070 CUDA Core Acceleration', score: 88, weight: 1.0, confidence: 0.88 },
      ],
      [TitanDimension.SOFTWARE_SUPPORT]: [
        { name: '1-Year Official Domestic Brand Warranty', score: 86, weight: 1.0, confidence: 0.88 },
      ],
      [TitanDimension.VALUE_FOR_MONEY]: [
        { name: 'Unmatched 36% Refurbished Deal Margin', score: 96, weight: 1.0, confidence: 0.95 },
      ],
    },
  },
];
